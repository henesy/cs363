...
* Examples:
    ...
    * * GUI_Browser_App.displayURL("http://www.javaworld.com")
      *
    * GUI_Browser_App.displayURL("file://c:\\docs\\index.html")
      *
	...
	public static void displayURL(String url) {
		...
		try {
			if (windows) {
				...
				cmd = WIN_PATH + " " + WIN_FLAG + " " + url; //url.substring(url.lastIndexOf('/')+1, url.length());
